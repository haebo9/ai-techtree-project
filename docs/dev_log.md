...
|:---:|:---:|:---:|:---|
| **26.05.20(수)** | 🔴 | **v2.0.0** | `v2.0.0` 정식 배포 및 깃태그 추가 |
| **26.05.19(화)** | 🟣 | **Fix** | 서비스 개발자 테스트 및 베타 테스트 진행, 소소한 에러 수정 |
| **26.05.18(월)** | ⚪️ | **Featr** | AWS 환경에 서비스 빌드 완료 및 테스트 | 
| **26.05.17(일)** | 🔵 | **Refactor** | v2.0 버전에 대한 문서 파일 점검 및 개선 | 
| **26.05.16(토)** | ⚪️ | **Refactor** | 도커 빌드를 위한 이전 도커 파일 전반적 개편 | 
| **26.05.15(금)** | 🟠 | **Refactor** | 배포를 위해 서비스 테마 및 디자인 변경 | 
...
| | 🟣 | **Feat** | `OpenAI Realtime(WebRTC)` 도입 및 실시간 음성 면접 로직 구현 |
